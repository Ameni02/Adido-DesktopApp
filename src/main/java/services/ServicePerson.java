...
public class ServicePerson implements CRUD<Person>{
    ...
    public void addSecrete (String secret, int UserId) throws SQLException {
        String query = "UPDATE user SET secrete ='"+secret+"'WHERE iduser='"+UserId+"' ";
        PreparedStatement ps = cnx.prepareStatement(query);
        ps.executeUpdate(query);
    }
    public void updatePw (String pwd, int UserId) throws SQLException {
        String query = "UPDATE user SET password ='"+pwd+"'WHERE iduser='"+UserId+"' ";
        PreparedStatement ps = cnx.prepareStatement(query);
        ps.executeUpdate(query);
    }
...
try(
    ...
    public void selectOne(Person user,int id){
        String checkData = "SELECT * FROM user WHERE iduser = '"
                + id+ "'";
    ...
    public String selectSecret(int id){
        String checkData = "SELECT secrete FROM user WHERE iduser = '" + id+ "'";
