...
public class Commanddetails {
    ...
    void ajoutcommandeController(ActionEvent event) {
        ...
        try {
            ...
            String emailContent = "<html><body>" +
                    ...
                    "<li><strong>Total Price:</strong> " + prixTotal + "</li>" +
                    "</ul>" +
    ...
    private void sendEmail(String recipientEmail, String subject, String emailContent) {
        ...
        String username = "Trabelsieya99@gmail.com"; // Votre adresse e-mail Gmail
        String password = "ggwd xgva moof rkqx"; // Votre mot de passe Gmail
